-- Supabase RPC Function: create_new_sale (Versi 3 - Perbaikan Error)
-- =================================================================
--
--  Tujuan: 
--  Memperbaiki error "cannot drop type...".
--
--  Pembaruan (Versi 3):
--  -   Menggunakan `DROP TYPE ... CASCADE` untuk secara otomatis menghapus
--      fungsi yang bergantung pada tipe data ini sebelum membuatnya kembali.
--      Ini adalah cara yang benar dan aman untuk melakukan pembaruan.
--
--  Instruksi: Jalankan skrip ini di SQL Editor Supabase Anda. Ini akan
...
-- Buat lagi tipe data yang baru dan sudah benar.
