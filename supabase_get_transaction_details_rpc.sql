-- Supabase RPC Function: get_transaction_details
-- =================================================================
--
--  Tujuan: 
--  Mengambil semua data yang diperlukan untuk menampilkan struk digital
--  atau detail transaksi dalam satu panggilan database yang efisien.
--
--  Fitur Utama:
--  1.  Data Lengkap: Menggabungkan data dari 6 tabel berbeda (transactions,
--      outlets, profiles, customers, transaction_items, payments).
--  2.  Format JSON: Mengembalikan satu objek JSON yang siap digunakan 
--      oleh frontend.
--  3.  Penamaan Varian: Sudah menyertakan logika untuk format nama
--      produk varian yang benar ("Produk - Varian").
--  4.  Efisien: Menggunakan subquery dan agregasi JSON di level database.
--
--  Input:
--  -   p_transaction_id (UUID): ID unik dari transaksi yang ingin dilihat.
--
--  Output:
--  -   Satu objek JSONB yang berisi semua detail transaksi.
--
