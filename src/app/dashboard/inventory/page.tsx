    ...
    return (
        <div className="flex flex-col w-full h-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <Link href="/dashboard/inventory/other-receivings" className="block p-6 bg-white dark:bg-gray-800 rounded-lg border hover:shadow-lg transition-shadow">
                     <div className="flex items-center gap-4"><div className="p-3 bg-green-100 dark:bg-green-900 rounded-lg"><PackagePlus className="h-6 w-6 text-green-600" /></div>
                        <div><h2 className="text-lg font-semibold">Penerimaan Lainnya</h2><p className="text-sm text-gray-500">Catat stok masuk di luar PO.</p></div>
                    </div>
                </Link>
