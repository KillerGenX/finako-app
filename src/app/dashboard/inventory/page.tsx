        ...
        <div className="flex flex-col w-full h-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <Link href="/dashboard/inventory/transfers" className="block p-6 bg-white dark:bg-gray-800 rounded-lg border hover:shadow-lg transition-shadow">
                    <div className="flex items-center gap-4"><div className="p-3 bg-teal-100 rounded-lg"><Move className="h-6 w-6 text-teal-600" /></div>
                ...
                <Link href="/dashboard/inventory/purchase-orders" className="block p-6 bg-white dark:bg-gray-800 rounded-lg border hover:shadow-lg transition-shadow">
                    <div className="flex items-center gap-4"><div className="p-3 bg-purple-100 rounded-lg"><FileText className="h-6 w-6 text-purple-600" /></div>
                ...
                <Link href="/dashboard/inventory/stock-report" className="block p-6 bg-white dark:bg-gray-800 rounded-lg border hover:shadow-lg transition-shadow">
                    <div className="flex items-center gap-4"><div className="p-3 bg-blue-100 rounded-lg"><BarChart3 className="h-6 w-6 text-blue-600" /></div>
                ...
                <div className="p-6 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-dashed">
                     <div className="flex items-center gap-4 opacity-50"><div className="p-3 bg-gray-200 rounded-lg"><ClipboardCheck className="h-6 w-6 text-gray-500" /></div>
                        <div><h2 className="text-lg font-semibold">Stok Opname</h2><p className="text-sm text-gray-500">(Segera Hadir)</p></div>
                    </div>
                </div>
                <div className="p-6 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-dashed">
                     <div className="flex items-center gap-4 opacity-50"><div className="p-3 bg-gray-200 rounded-lg"><ArchiveX className="h-6 w-6 text-gray-500" /></div>
                        <div><h2 className="text-lg font-semibold">Barang Rusak/Hilang</h2><p className="text-sm text-gray-500">(Segera Hadir)</p></div>
                    </div>
                </div>
                <div className="p-6 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-dashed">
                     <div className="flex items-center gap-4 opacity-50"><div className="p-3 bg-gray-200 rounded-lg"><PackagePlus className="h-6 w-6 text-gray-500" /></div>
