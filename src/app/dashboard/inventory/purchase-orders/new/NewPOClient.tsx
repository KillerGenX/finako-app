...
import { ArrowLeft, Search, Trash2, Loader2, Info } from 'lucide-react';

// ... (Komponen ProductSearch dan tipe data tidak berubah)
...
function ProductSearch({ onProductSelect }: { onProductSelect: (product: ProductVariantSearchResult) => void }) {
    ...
    return (
        <div className="relative">
            ...
            <input type="text" value={query} onChange={(e) => setQuery(e.target.value)} placeholder="Cari produk..." className="w-full pl-10 pr-4 py-2 border rounded-lg bg-white dark:bg-gray-800" />
                ...
                <div className="md:col-span-2 space-y-4">
                    ...
                    <div className="border rounded-lg w-full bg-white dark:bg-gray-800/50">
                        <table className="w-full text-sm">
                            <thead><tr className="border-b"><th className="p-3 text-left font-medium">Produk</th><th className="p-3 font-medium w-28">Harga Beli/Unit</th><th className="p-3 font-medium w-24">Jumlah</th><th className="p-3 font-medium w-12"></th></tr></thead>
                            <tbody>
