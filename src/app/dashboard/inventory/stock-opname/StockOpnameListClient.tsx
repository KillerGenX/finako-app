...
// --- Komponen Modal ---
function StartOpnameModal({ outlets, onClose, isStarting }: {
    outlets: Outlet[],
    onClose: () => void,
    isStarting: boolean
}) {
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex justify-center items-center p-4">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-sm">
                ...
                <div className="p-4 bg-gray-50 dark:bg-gray-700/50 flex justify-end gap-2 rounded-b-lg">
                    ...
                    <button onClick={handleStart} disabled={isStarting || !selectedOutlet} className="px-4 py-2 rounded bg-teal-600 text-white disabled:bg-gray-400 flex items-center">
...
export function StockOpnameListClient({ opnames, outlets }: {
    ...
    return (
        <>
            {isModalOpen && <StartOpnameModal outlets={outlets} onClose={() => setIsModalOpen(false)} isStarting={isPending} />}
            ...
            <div className="flex items-center justify-between mb-6">
                ...
                <button onClick={() => startTransition(() => setIsModalOpen(true))} className="bg-teal-600 text-white px-4 py-2 rounded-lg flex items-center gap-2">
